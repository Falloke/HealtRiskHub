  ...
  return (
    ...
    >
      ...
      <nav
        ...
        className="flex h-16 items-center justify-between bg-pink-200/95 px-6 shadow-md backdrop-blur supports-[backdrop-filter]:bg-pink-200/80"
      >
        {/* Logo และเมนูซ้าย */}
        <div className="flex items-center gap-8">
          <Link
            href="/"
            className="text-2xl font-bold text-pink-700 hover:opacity-90"
          >
            HealthRiskHub
          </Link>
